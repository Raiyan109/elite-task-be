...
exports.getFashionBrands = exports.getFashionSectionProducts = void 0;
...
const getFashionSectionProducts = (sectionField_1, categoryName_1, ...args_1) => __awaiter(void 0, [sectionField_1, categoryName_1, ...args_1], void 0, function* (sectionField, categoryName, limit = 10) {
    const pipeline = [
        {
            $match: {
...
exports.getFashionSectionProducts = getFashionSectionProducts;
// checking directly from brand since BrandModel has field category_id
const getFashionBrands = (categoryName) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getFashionBrands = getFashionBrands;
