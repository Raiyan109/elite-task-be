...
const postCartService = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield Promise.all(cartItems.map((item) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (item.type === "combo") {
            ...
            const quantities = (combo.combo_products || [])
                .map((cp) => { var _a; return (_a = cp === null || cp === void 0 ? void 0 : cp.product_id) === null || _a === void 0 ? void 0 : _a.product_quantity; })
            ...
            const totalComboPrice = (combo.combo_products || []).reduce((sum, cp) => {
                const cpPrice = (cp === null || cp === void 0 ? void 0 : cp.combo_price) || 0;
                return sum + cpPrice;
            }, 0);
            const result = {
                _id: combo._id,
...
const incrementProductQuantityService = (userId, productId) => __awaiter(void 0, void 0, void 0, function* () {
    const cart = yield cart_model_1.CartModel.findOne({ user_id: userId });
    if (!cart) {
        return null;
    }
    const itemIndex = cart.cart_items.findIndex(item => item._id.toString() === productId);
    if (itemIndex >= 0) {
    ...
    if (updatedCart.cart_items.length === 0) {
        yield cart_model_1.CartModel.deleteOne({ _id: updatedCart._id });
        return null;
    }
    return updatedCart;
});
const decrementProductQuantityService = (userId, productId) => __awaiter(void 0, void 0, void 0, function* () {
    const cart = yield cart_model_1.CartModel.findOne({ user_id: userId });
    if (!cart)
        throw new Error('Cart not found');
    const itemIndex = cart.cart_items.findIndex(item => item._id.toString() === productId.toString());
    if (itemIndex === -1)
    ...
    if (cart.cart_items.length === 0) {
        yield cart_model_1.CartModel.deleteOne({ user_id: userId });
        return null; // or return a message saying "Cart deleted"
    }
    yield cart.save();
    return cart;
});
const removeCartItemService = (userId, productId) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedCart = yield cart_model_1.CartModel.findOneAndUpdate({ user_id: userId }, {
...
const getCartService = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cart_model_1.CartModel.findOne({ user_id: userId });
    return result;
});
