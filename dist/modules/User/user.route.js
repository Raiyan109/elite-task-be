...
router.post('/send-otp-phone', user_controller_1.UserControllers.sendPhoneOtp);
...
router.post('/delete-account', (0, auth_1.auth)('user'), user_controller_1.UserControllers.deleteUserOwnAccount);
